                            ...
                            <Tooltip delayDuration={100}>
                                <TooltipTrigger asChild>
                                    <div
                                        className={cn(
                                            ...
                                            badge.earned
                                                ? "bg-gradient-to-br from-[#1A232E] to-[#0D1219] ring-blue-500/20 hover:ring-blue-500/50 hover:shadow-[0_0_20px_rgba(46,129,255,0.15)]"
                                    ...
                                    >
                                        <IconComponent
                                            className={cn(
                                                ...
                                                badge.earned
                                                    ? "text-blue-400 group-hover:scale-110 group-hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]"
                                                    : "text-zinc-600"
                                            )}
                                        />
                                ...
                                <TooltipContent side="top" className="bg-[#161B22] border-white/10 text-white p-3 shadow-xl">
                                    <div className="text-center">
                                        ...
                                        {badge.earned ? (
                                            <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-[10px] font-bold text-blue-400 uppercase tracking-wider">
                                                Unlocked
                                            </div>
                                        ) : (
