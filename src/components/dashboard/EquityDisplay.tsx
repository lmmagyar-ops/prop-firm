...
export function EquityDisplay({ currentBalance, dailyPnL }: EquityDisplayProps) {
    return (
        <div className="text-center p-8 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl border border-white/5 h-full flex flex-col justify-center items-center">
            <div className="text-sm text-zinc-400 mb-2 uppercase tracking-wider font-bold">Current Equity</div>
            <BigNumberDisplay value={currentBalance} suffix="USD" className="text-5xl md:text-6xl font-medium text-white" />
