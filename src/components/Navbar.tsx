        ...
        <nav className="absolute top-0 left-0 right-0 z-50 w-full border-b border-[#2E3A52] bg-[#0E1217]/80 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 md:gap-6 flex-shrink-0">
                    ...
                    <Link href="/signup" className="group relative px-3 py-2 md:px-6 md:py-2.5 bg-white text-black text-[10px] md:text-xs font-black uppercase tracking-wider rounded-lg overflow-hidden hover:scale-105 active:scale-95 transition-all whitespace-nowrap">
